    ...
    <?php 
        ...
        if ($messages != 0) {
            if (isset($_GET['success'])) {
                ...
                echo '<div class="alert alert-success .w-450 m-5" role="alert">' . $success_message . '</div>';
            } elseif (isset($_GET['error'])) {
                $error_message = $_GET['error'];
                echo '<div class="alert alert-danger .w-450 m-5" role="alert">' . $error_message . '</div>';
            }
    ?>
            ...
            <div class="accordion-item">
                ...
                <div id="flush-collapse_<?=$message['message_id']?>" class="accordion-collapse collapse" aria-labelledby="flush-heading_<?=$message['message_id']?>" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        ...
                        <a href="message-delete.php?message_id=<?=$message['message_id']?>" class="btn btn-danger">Delete</a>
                    </div>
                </div>
            </div>
            <?php } ?>
